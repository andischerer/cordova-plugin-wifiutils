...
declare type wifiConnectionState = 'CONNECTING' | 'CONNECTED' | 'SUSPENDED' | 'DISCONNECTING' | 'DISCONNECTED' | 'UNKNOWN';
declare type wifiApState = 'WIFI_AP_STATE_DISABLING' | 'WIFI_AP_STATE_DISABLED' | 'WIFI_AP_STATE_ENABLING' | 'WIFI_AP_STATE_ENABLED' | 'WIFI_AP_STATE_FAILED';
